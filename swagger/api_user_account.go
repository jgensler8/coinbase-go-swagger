...
/* 
UserAccountApiService Trailing Volume
...
@return []VolumeItem
*/
func (a *UserAccountApiService) UsersSelfTrailingVolumeGet(ctx context.Context, cBACCESSKEY string, cBACCESSSIGN string, cBACCESSTIMESTAMP string, cBACCESSPASSPHRASE string) ([]VolumeItem, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []VolumeItem
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/self/trailing-volume"
