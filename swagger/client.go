...
// APIClient manages communication with the Coinbase Pro API API v2.0.0
...
type APIClient struct {
	...
	StablecoinConversionsApi *StablecoinConversionsApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.StablecoinConversionsApi = (*StablecoinConversionsApiService)(&c.common)
